...
class _RankingScreenState extends State<RankingScreen> {
  ...
  Widget build(BuildContext context) {
    return Theme(
      // Copiem el tema actual i només sobreescrivim la font per posar la de Pokemon
      data: Theme.of(context).copyWith(
        textTheme: Theme.of(context).textTheme.apply(fontFamily: 'PokemonGb'),
      ),
      ...
      body: RefreshIndicator(
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, i) {
            ...
            final pokemon = _items[i];
            return PokemonCard(
              key: ValueKey('${pokemon.id}_${pokemon.favorite}'),   
              pokemon: pokemon,
              onFavoriteChanged: () async {
                ...
                setState(() {
                  _items[i] = pokemon.copyWith(favorite: !pokemon.favorite);
                });
              },
            );
          },
