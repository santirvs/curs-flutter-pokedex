...
mixin _$Pokemon {
 ...
 int get id; String get name; PokemonType get type; int get hp; int get attack; int get defense; String? get imageUrl;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,type,hp,attack,defense,imageUrl);

@override
String toString() {
  return 'Pokemon(id: $id, name: $name, type: $type, hp: $hp, attack: $attack, defense: $defense, imageUrl: $imageUrl)';
}
...
@useResult
$Res call({
 int id, String name, PokemonType type, int hp, int attack, int defense, String? imageUrl
});
...
/// Create a copy of Pokemon
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? type = null,Object? hp = null,Object? attack = null,Object? defense = null,Object? imageUrl = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  PokemonType type,  int hp,  int attack,  int defense,  String? imageUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Pokemon() when $default != null:
return $default(_that.id,_that.name,_that.type,_that.hp,_that.attack,_that.defense,_that.imageUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  PokemonType type,  int hp,  int attack,  int defense,  String? imageUrl)  $default,) {final _that = this;
switch (_that) {
case _Pokemon():
return $default(_that.id,_that.name,_that.type,_that.hp,_that.attack,_that.defense,_that.imageUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  PokemonType type,  int hp,  int attack,  int defense,  String? imageUrl)?  $default,) {final _that = this;
switch (_that) {
case _Pokemon() when $default != null:
return $default(_that.id,_that.name,_that.type,_that.hp,_that.attack,_that.defense,_that.imageUrl);case _:
  return null;
...
class _Pokemon implements Pokemon {
  const _Pokemon({required this.id, required this.name, required this.type, required this.hp, required this.attack, required this.defense, this.imageUrl});
...
/// Create a copy of Pokemon
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? type = null,Object? hp = null,Object? attack = null,Object? defense = null,Object? imageUrl = freezed,}) {
